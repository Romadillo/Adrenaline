...
package net.mcreator.adrenaline.particle;
...
public class ShadowStrikeParticleParticle extends AdrenalineModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public ShadowStrikeParticleParticle(AdrenalineModElements instance) {
		super(instance, 10);
