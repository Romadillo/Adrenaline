...
public class DoubleJumpJumpEnchantment extends AdrenalineModElements.ModElement {
	@ObjectHolder("adrenaline:double_jump_jump")
	public static final Enchantment enchantment = null;
	public DoubleJumpJumpEnchantment(AdrenalineModElements instance) {
		super(instance, 24);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("double_jump_jump"));
	}
