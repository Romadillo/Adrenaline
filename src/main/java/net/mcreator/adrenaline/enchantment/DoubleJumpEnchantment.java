...
public class DoubleJumpEnchantment extends AdrenalineModElements.ModElement {
	@ObjectHolder("adrenaline:double_jump")
	public static final Enchantment enchantment = null;
	public DoubleJumpEnchantment(AdrenalineModElements instance) {
		super(instance, 22);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("double_jump"));
	}
	public static class CustomEnchantment extends Enchantment {
		...
		protected boolean canApplyTogether(Enchantment ench) {
			...
			if (ench == MedusasGazeEnchantment.enchantment)
				return true;
			if (ench == DoubleJumpEnchantment.enchantment)
				return true;
